...
func ExampleTransformToXYZForPrimaries_generateAdobeRGBMatrix() {
	transform := ciexyz.TransformToXYZForPrimaries(0.64, 0.33, 0.21, 0.71, 0.15, 0.06, ciexyz.WhitePointD65)
...
func ExampleTransformFromXYZForPrimaries_generateAdobeRGBMatrix() {
	transform := ciexyz.TransformFromXYZForPrimaries(0.64, 0.33, 0.21, 0.71, 0.15, 0.06, ciexyz.WhitePointD65)
